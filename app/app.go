...
import (
	...
	appparams "github.com/shravanshetty1/samachar/app/params"
	"github.com/shravanshetty1/samachar/x/samachar"
	samacharkeeper "github.com/shravanshetty1/samachar/x/samachar/keeper"
	samachartypes "github.com/shravanshetty1/samachar/x/samachar/types"
...
type App struct {
	*baseapp.BaseApp
	...
	samacharKeeper samacharkeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		samachartypes.StoreKey, feegrant.StoreKey,
	...
	app.samacharKeeper = *samacharkeeper.NewKeeper(
		appCodec, keys[samachartypes.StoreKey], keys[samachartypes.MemStoreKey], bApp, app.BankKeeper)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		samachar.NewAppModule(appCodec, app.samacharKeeper),
	...
	app.mm.SetOrderEndBlockers(crisistypes.ModuleName, govtypes.ModuleName, stakingtypes.ModuleName, samachartypes.ModuleName)
