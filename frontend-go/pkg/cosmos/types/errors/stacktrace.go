...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/shravanshetty1/samachar/frontend-go/pkg/cosmos/types/errors.Wrap",
		"github.com/shravanshetty1/samachar/frontend-go/pkg/cosmos/types/errors.Wrapf",
		"github.com/shravanshetty1/samachar/frontend-go/pkg/cosmos/types/errors.WithType",
