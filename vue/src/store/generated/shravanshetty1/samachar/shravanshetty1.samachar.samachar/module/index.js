...
var post_1 = require("./types/samachar/post");
var types = [
    ["/shravanshetty1.samachar.samachar.MsgCreatePost", post_1.MsgCreatePost],
];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, stargate_1.SigningStargateClient.connectWithSigner(addr, wallet, { registry: registry })];
                case 1:
                    client = _c.sent();
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            ...
                            msgCreatePost: function (data) { return ({ typeUrl: "/shravanshetty1.samachar.samachar.MsgCreatePost", value: data }); }
                        }];
            }
        });
    });
...
var queryClient = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_c) {
            return [2 /*return*/, new rest_1.Api({ baseUrl: addr })];
        });
    });
};
